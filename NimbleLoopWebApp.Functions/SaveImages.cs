...
public class SaveImages(ILogger<SaveImages> logger, BlobServiceClient blobServiceClient)
{
	private readonly ILogger<SaveImages> _logger = logger;
	private readonly BlobServiceClient _blobServiceClient = blobServiceClient;

	[Function(nameof(SaveImages))]
